...
# Squid的配置文件语法
# 将请求转发到父代理
# cache_peer 121.201.124.48 parent 25824 0 no-query weighted-round-robin weight=1 login=yhxd:yhxd@1234 connect-fail-limit=2 allow-miss max-conn=5
...
def ip_from_conf():
    with open('/etc/squid/squid.conf', 'r', encoding='UTF-8') as f:
        ...
        # [('115.215.50.184 parent 40918 ', '40918'),
        #  ('27.156.147.231 parent 31730 ', '31730')]
        return p_list
...
def get_proxy(num):
    ...
    # 1. 获取代理IP资源
    api_url = 'http://api.xdaili.cn/xdaili-api//greatRecharge/getGreatIp?spiderId=9e8d9392d8024dd99b056a88bd344a8a&orderno=YZ20186229431ZoASvQ&returnType=2&count={}'.format(num)
